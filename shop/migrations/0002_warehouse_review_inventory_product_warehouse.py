    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Отчество владельца', models.CharField(blank=True, max_length=255, null=True)),
                ('location', models.CharField(max_length=255, verbose_name='Расположение')),
                ('type_post', models.CharField(choices=[('AR', 'Отправка самолетом'), ('TR', 'Отправка поездом'), ('TC', 'Отправка грузовиком'), ('AL', 'Любой вид отправки')], default='AL', max_length=2, verbose_name='Способ отправки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='image/review/%Y/%m/%d', verbose_name='Фото в отзыве')),
