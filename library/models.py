...
class Publishing_house(models.Model):
    ...
    agent_name = models.CharField(max_length=50, verbose_name='Имя агента')
    agent_lastname = models.CharField(max_length=50, verbose_name='Фамилия агента')
    agent_surname = models.CharField(max_length=50, null=True, blank=True, verbose_name='Отчество агента')
    telephone = models.CharField(max_length=20, verbose_name='Номер телефона')

    def __str__(self):
        return self.title + "(" + self.agent_name + " " + self.agent_lastname + ") | " + self.telephone
